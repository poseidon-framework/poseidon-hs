...
- V 0.12.0: `trident list --individuals` now allows for adding arbitrary janno-columns. This also works with the new server version, which now returns all janno entries.