- V 1.2.0.0: Implemented the changes for Poseidon v2.7.1 and thus deprecated the support for the broken v2.7.0, added stricter validation for the .ssf file, elevated the log level of broken lines from debug to error and switched to a new stylish-haskell version for linting.
