...
testReadSeqSourceFile = describe "Poseidon.SequencingSource.readSeqSourceFile" $ do
    ...
    it "should read normal .ssf files correctly" $ do
        ...
        map sFastqFTP s                  `shouldBe` [ Just $ JURI "ftp.sra.ebi.ac.uk/vol1/fastq/ERR433/006/ERR4331996/ERR4331996.fastq.gz"
                                                    , Just $ JURI "ftp.sra.ebi.ac.uk/vol1/fastq/ERR433/002/ERR4332592/ERR4332592.fastq.gz"
                                                    , Just $ JURI "ftp.sra.ebi.ac.uk/vol1/fastq/ERR433/003/ERR4332593/ERR4332593.fastq.gz"
                                                    ]
        map sFastqASPERA s               `shouldBe` [ Just $ JURI "fasp.sra.ebi.ac.uk:/vol1/fastq/ERR433/006/ERR4331996/ERR4331996.fastq.gz"
                                                    , Just $ JURI "fasp.sra.ebi.ac.uk:/vol1/fastq/ERR433/002/ERR4332592/ERR4332592.fastq.gz"
                                                    , Just $ JURI "fasp.sra.ebi.ac.uk:/vol1/fastq/ERR433/003/ERR4332593/ERR4332593.fastq.gz"
                                                    ]
        map sFastqBytes s                `shouldBe` [Just 649563861, Just 194164761, Just 276693447]
        map sFastqMD5 s                  `shouldBe` [ Just "9bd0fceb5ab46cb894ea33765c122e83"
                                                    , Just "6d8831f5bb8ba9870cb55f834e98ab4d"
                                                    , Just "539852f3d7fb574b2a1e4f1c0059f163"
                                                    ]
        map sReadCount s                 `shouldBe` [Just 23386349, Just 6471092, Just 9442394]
        map sSubmittedFTP s              `shouldBe` [ Just $ JURI "ftp.sra.ebi.ac.uk/vol1/run/ERR433/ERR4331996/Ash033_all.merged.hs37d5.fa.cons.90perc.bam"
                                                    , Just $ JURI "ftp.sra.ebi.ac.uk/vol1/run/ERR433/ERR4332592/Ash002_all.merged.hs37d5.fa.cons.90perc.bam"
                                                    , Just $ JURI "ftp.sra.ebi.ac.uk/vol1/run/ERR433/ERR4332593/Ash040_all.merged.hs37d5.fa.cons.90perc.bam"
                                                    ]
