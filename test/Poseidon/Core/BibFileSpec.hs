...
testBibReadWriteReadCycle = describe
    "Poseidon.Core.BibFile.readBibTeXFile and Poseidon.Core.BibFile.writeBibTeXFile" $ do
...
testParseAuthors = describe "Poseidon.Core.BibFile.parseAuthors" $ do
...
testAuthorAbbrvString = describe "Poseidon.Core.BibFile.authorAbbrvString" $ do
